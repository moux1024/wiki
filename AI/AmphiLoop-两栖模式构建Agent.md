...
- [[Memoh — 为每个 AI Agent 提供专属云计算机]] — 同为多 Agent 平台，Memoh 侧重容器化部署和长期记忆，AmphiLoop 侧重两栖模式切换
...
- [[Claude-Code在大型代码库中的最佳实践]] — Claude Code 的 Subagent 模式与 AmphiLoop 的两栖模式都涉及 Agent 实例的协作分工，可对照阅读
